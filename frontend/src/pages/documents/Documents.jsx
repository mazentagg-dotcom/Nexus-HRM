    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
      ...
      <motion.div variants={fadeUp}>
        <AnimatedTable columns={[
          ...
          { key: 'document_type', label: 'Type', render: v => <Badge color={typeColors[v] || 'gray'}>{v ? v.replace(/_/g, ' ') : v}</Badge> },
          ...
          { key: 'file_size', label: 'Size', render: v => <span className="text-gray-500 text-xs">{v ? fmtBytes(v) : '-'}</span> },
